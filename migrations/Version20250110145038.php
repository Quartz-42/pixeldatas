 ...
 */
final class Version20250110145038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evolution CHANGE pokemon_id pokemon_id INT NOT NULL, CHANGE is_mega_evolution is_mega_evolution TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evolution CHANGE pokemon_id pokemon_id INT DEFAULT NULL, CHANGE is_mega_evolution is_mega_evolution TINYINT(1) DEFAULT NULL');
    }
}
